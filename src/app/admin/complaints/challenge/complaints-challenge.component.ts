...
@Component({
  selector: 'app-complaints-challenge',
  templateUrl: './complaints-challenge.component.html',
  styleUrls: ['./complaints-challenge.component.scss']
})
export class ComplaintsChallengeComponent implements OnInit, AfterViewInit {
  ...
  constructor(private complaintsService: ComplaintsService,
    ...
    this.complaintsService.setPath = 'challenges';
    this.blockedService.setPath = 'challenges';
  }
  ...
  ngOnInit() {
    ...
    this.displayedColumns = ['index', 'author', 'challenge', 'reason', 'reviewed', 'action'];
  }
